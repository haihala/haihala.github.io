...
\begin{skills}
    \skillitem{3}{Rust, TS/JS, Python, Git, Bevy, Google cloud platform (ex-certified professional cloud architect), React, Web development, Linux, Docker, Shell scripts}
    \skillitem{2}{Godot, Unity, Blender, Scrum, Agile, Teaching, Project management, C\#, SQL, Java, B2B Customer communication, Microsoft Azure, Terraform, Django, FastAPI, NodeJS, Lua, Svelte}
    \skillitem{1}{Unreal engine, Go, Zig, C++, C, Haskell, PHP, MongoDB, \LaTeX, NextJS, Kotlin, Bun, Deno, Angular, AWS, HTMX}
\end{skills}

What I mean by each level:

\begin{etaremune}
    \item I'm as confident in these as I can be. Average experience: 4 years.
    \item What I think of as basic competence, but others keep telling me is a high bar. Average experience: A year.
